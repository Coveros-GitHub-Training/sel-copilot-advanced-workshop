...
| [Lab 6](Labs/Lab-6-Custom-Chat-Modes-and-Agents.md) | Custom Chat Modes and Custom Agents | 20 min | Build custom chat modes and agents for specialized, autonomous workflows |
