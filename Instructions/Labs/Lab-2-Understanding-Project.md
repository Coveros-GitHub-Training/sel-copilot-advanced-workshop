...
In the next exercise, we'll use what we've learned about the codebase to start building new features and generating code with GitHub Copilot's Edit mode and code completions!
