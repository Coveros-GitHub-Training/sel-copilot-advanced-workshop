...
### 🎓 Prompt File Engineering Fundamentals

**Anatomy of an Excellent Prompt File:**
...
## Constraints
- Must use TypeScript
- Follow existing patterns in X file
...
## Examples
Show examples of good vs. bad outputs.
```

### 🏗️ Prompt File Architecture Patterns

**Pattern 1: The Template Generator**
Perfect for creating new files with consistent structure:
```markdown
---
...
Create a new ${input:type:functional} React component.

Component details:
- Name: ${input:name:MyComponent}
- Location: src/components/${input:folder:ui}/${input:name}.tsx
- Props: ${input:props:none}
...
**Pattern 2: The Refactoring Assistant**
...
Refactor the selected code with these priorities:

1. **Performance**: ${input:performance:Optimize for speed}
2. **Readability**: ${input:readability:Improve variable names}
3. **Maintainability**: ${input:maintainability:Reduce complexity}

Current file: ${file}
Project patterns: @.github/copilot-instructions.md

Specific concerns to address:
${input:concerns:none specified}

Provide before/after comparison and explain improvements.
```

**Pattern 3: The Documentation Writer**
For comprehensive docs:
```markdown
---
description: 'Generate complete documentation for component'
mode: 'ask'
---

Create comprehensive documentation for: ${file}
...
Generate tests for: ${input:target:current file}

Test coverage requirements:
- Unit tests: ${input:unit:✅}
- Integration tests: ${input:integration:✅}
- E2E tests: ${input:e2e:❌}

Focus areas:
1. Happy path scenarios
2. Edge cases: ${input:edges:empty, null, undefined}
3. Error conditions: ${input:errors:network failures, invalid input}
4. Performance: ${input:performance:❌}

Testing framework: ${input:framework:Jest + React Testing Library}
Coverage target: ${input:coverage:80%}
...
### 🎯 Advanced Prompt File Techniques

#### **Technique 1: Context Chaining**
Build prompts that reference other files for consistency:

```markdown
---
description: 'Create feature following architecture'
mode: 'agent'
---

Analyze the architecture in @ARCHITECTURE.md
Review patterns in @src/components/ui/layout/
Examine similar feature in @src/app/gallery/page.tsx

Now create: ${input:feature:new feature}
...
Create prompts that iterate and improve:
...
Build flexible prompts with options:
...
Component type: ${input:type:functional|class|hook}
...
Additional features:
- Memoization: ${input:memo:no}
- Error boundary: ${input:errorBoundary:no}
- Loading states: ${input:loading:yes}
- Accessibility: always ✅
```

#### **Technique 4: Multi-File Operations**
Coordinate changes across files:

```markdown
---
description: 'Add new feature across multiple files'
mode: 'agent'
tools: ['codebase', 'editFiles', 'search']
---

Feature: ${input:feature:New feature name}

Step 1: Create component
File: src/components/${input:folder}/${input:name}.tsx

Step 2: Add types
File: src/types/${input:name}.types.ts

Step 3: Create tests
File: src/components/${input:folder}/__tests__/${input:name}.test.tsx

Step 4: Update exports
File: src/components/${input:folder}/index.ts

Step 5: Add to documentation
File: docs/components/${input:name}.md

Ensure all files are consistent and follow project patterns.
```

### 📚 Prompt File Library for PixelPerfect Gallery

Here are specialized prompts for common tasks in the gallery project:

#### **Photo Management Prompts**

**generate-photo-feature.prompt.md**
```markdown
---
description: 'Add photo-related feature'
mode: 'agent'
---

Create a new photo management feature for PixelPerfect Gallery.

Feature: ${input:feature:Photo feature name}
Location: ${input:location:gallery|upload|admin}

Requirements:
- Use existing Photo interface from @src/lib/mock-photo-data.ts
- Follow GalleryGrid component patterns
- Include responsive design
- Add dark mode support
- Implement loading states
- Add error handling for failed operations

Style with Tailwind CSS following existing patterns in:
@src/components/ui/layout/

Include unit tests using Jest + React Testing Library.
```

**optimize-photo-component.prompt.md**
```markdown
---
description: 'Optimize photo rendering performance'
mode: 'edit'
---

Optimize the selected photo component for performance:
...
5. Virtual scrolling for large lists (if applicable)
...
```markdown
---
description: 'Create integration tests for feature'
mode: 'agent'
---

Generate integration tests for: ${input:feature:feature name}
...
Test scenarios:
1. ${input:scenario1:User uploads photo}
2. ${input:scenario2:User views gallery}
3. ${input:scenario3:User filters photos}
...
**Problem**: Prompt produces inconsistent results
```markdown
Solution:
- Add more specific constraints
- Reference exact files to follow
- Include examples of desired output
- Specify exact format required
- Add validation criteria
```

**Problem**: Prompt is too slow
```markdown
Solution:
- Simplify context requirements
...
**Problem**: Output doesn't match project style
```markdown
Solution:
- Reference @.github/copilot-instructions.md
- Add specific style examples
...
- `fetch` - Retrieve external content
- `terminal` - Execute commands
- `git` - Git operations

### 🏗️ Advanced Chat Mode Patterns

#### **Pattern 1: The Expert Reviewer**
Create a code review specialist mode:
...
Reference project patterns in @.github/copilot-instructions.md
...
#### **Pattern 2: The Debugging Detective**
Specialized debugging assistant:
...
You are an expert debugger who solves problems methodically.
...
#### **Pattern 3: The Performance Optimizer**

```markdown
---
description: 'Performance analysis and optimization'
tools: ['codebase', 'terminal']
model: 'premium-analysis-model'
---
...
### 🚀 Optimization Plan
1. Quick wins (< 1 hour)
2. Medium efforts (1-4 hours)
3. Large projects (> 4 hours)

### 📈 Expected Improvements
- Speed increase: X%
- Bundle size reduction: Y KB
- Memory savings: Z MB
...
#### **Pattern 4: The Documentation Writer**

```markdown
---
description: 'Create comprehensive, user-friendly documentation'
tools: ['codebase', 'search']
---

# Documentation Writer Mode

You are a technical writer who creates crystal-clear documentation.
...
3. Detailed guide (comprehensive)
...
- Callout boxes (💡 Tips, ⚠️ Warnings, 📝 Notes)
- Tables for comparisons
- Lists for steps
- Links to related docs
```

#### **Pattern 5: The Test Architect**
...
You are a QA expert who designs thorough test strategies.
...
For PixelPerfect Gallery, create specialized modes:

#### **Gallery Feature Mode**
```markdown
---
description: 'Build photo gallery features'
tools: ['codebase', 'editFiles']
---

# Gallery Feature Developer

You specialize in photo gallery features for PixelPerfect Gallery.
...
1. Review similar features in:
   - @src/components/gallery/
   - @src/app/gallery/page.tsx

2. Use existing patterns:
   - GalleryGrid for displays
   - Photo interface for types
